...
export const en: Dict = {
  ...
  'settings.subtitle':
    'Pick where generations run, paste in any model API keys, and choose your interface language.',
  ...
  'settings.tabExecutionHint': 'Code agent or Anthropic API',
  'settings.tabMedia': 'Media',
  'settings.tabMediaHint': 'Image / video / audio keys',
  'settings.tabLanguage': 'Language',
  'settings.tabLanguageHint': 'Interface language',
  'settings.tabsAria': 'Settings sections',
  'settings.mediaProviders': 'Media providers',
  'settings.mediaProvidersHint':
    'API keys for image / video / audio generation. Stored locally and pushed to your daemon over 127.0.0.1 — never proxied through us.',
  'settings.mediaProviderApiKey': 'API key',
  'settings.mediaProviderBaseUrl': 'Base URL (optional)',
  'settings.mediaProviderConfigured': 'Configured',
  'settings.mediaProviderUnset': 'Not configured',
  'settings.mediaProviderEnv': 'Env var',
  'settings.mediaProviderIntegrated': 'Integrated',
  'settings.mediaProviderPending': 'Stub (integration pending)',
  'settings.mediaProviderDocs': 'Get a key →',
  ...
  'settings.mediaSectionExpand': 'Show advanced',
  'settings.mediaSectionCollapse': 'Hide advanced',
  ...
  'promptTemplates.emptyImage': 'No image prompt templates installed yet. Run `node scripts/import-prompt-templates.mjs` to fetch the curated set.',
  'promptTemplates.emptyVideo': 'No video prompt templates installed yet. Run `node scripts/import-prompt-templates.mjs` to fetch the curated set.',
  'promptTemplates.emptyNoMatch': 'No templates match your search.',
  'promptTemplates.attributionFooter': 'Adapted from public CC BY 4.0 prompt libraries by YouMind OpenLab. Each card links back to the original author. See CREDITS.md.',
  'promptTemplates.openPreviewTitle': 'Open prompt + preview',
  ...
  'newproj.modelConfigureCta': 'Configure key',
  'newproj.modelConfigureTitle': 'Add an API key for {provider} in Settings',
  'newproj.modelNeedsKeyTitle': '{provider} needs an API key',
  'newproj.modelNeedsKeyBody':
    "Generation will fall back to a placeholder until you paste a key.",
  ...
  'newproj.promptTemplateLabel': 'Prompt template (optional)',
  'newproj.promptTemplateNone': 'No template — write from scratch',
  'newproj.promptTemplateNoneSub': 'Use only your brief',
  'newproj.promptTemplateSearch': 'Search templates…',
  'newproj.promptTemplateEmpty': 'No matches.',
