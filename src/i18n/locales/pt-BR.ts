...
const ptBROverrides: Partial<Dict> = {
  ...
  'entry.tabImageTemplates': 'Templates de imagem',
  'entry.tabVideoTemplates': 'Templates de vídeo',

  'promptTemplates.searchPlaceholder': 'Pesquisar templates…',
  'promptTemplates.countLabel': '{n} resultados',
  'promptTemplates.emptyImage': 'Nenhum template de prompt de imagem instalado. Rode `node scripts/import-prompt-templates.mjs` para baixar a coleção curada.',
  'promptTemplates.emptyVideo': 'Nenhum template de prompt de vídeo instalado. Rode `node scripts/import-prompt-templates.mjs` para baixar a coleção curada.',
  'promptTemplates.emptyNoMatch': 'Nenhum template corresponde à busca.',
  'promptTemplates.attributionFooter': 'Adaptado das bibliotecas públicas CC BY 4.0 da YouMind OpenLab. Cada cartão tem link para o autor original. Veja CREDITS.md.',
  'promptTemplates.openPreviewTitle': 'Abrir prompt + preview',
  'promptTemplates.sourcePrefix': 'Fonte:',
  'promptTemplates.fetchError': 'Não foi possível carregar o conteúdo deste template.',
  ...
  'promptTemplates.openFullscreen': 'Pré-visualização em tela cheia',
  'promptTemplates.closeFullscreen': 'Sair da tela cheia',
  ...
  'newproj.promptTemplateLabel': 'Template de prompt (opcional)',
  'newproj.promptTemplateNone': 'Sem template — escrever do zero',
  'newproj.promptTemplateNoneSub': 'Usar somente o seu briefing',
  'newproj.promptTemplateSearch': 'Pesquisar templates…',
  'newproj.promptTemplateEmpty': 'Sem correspondências.',
