...
export const zhCN: Dict = {
  ...
  'settings.tabExecution': '执行方式',
  'settings.tabExecutionHint': '本机 CLI 或 Anthropic API',
  'settings.tabMedia': '媒体生成',
  'settings.tabMediaHint': '图片 / 视频 / 音频 API Key',
  'settings.tabLanguage': '语言',
  'settings.tabLanguageHint': '界面语言',
  'settings.tabsAria': '设置分区',
  'settings.mediaProviders': '媒体生成提供商',
  'settings.mediaProvidersHint':
    '配置图片/视频/音频生成的 API Key。仅保存在本地浏览器，并通过 127.0.0.1 推送给本机 daemon —— 不经过任何代理。',
  'settings.mediaProviderApiKey': 'API Key',
  'settings.mediaProviderBaseUrl': 'Base URL（可选）',
  'settings.mediaProviderConfigured': '已配置',
  'settings.mediaProviderUnset': '未配置',
  'settings.mediaProviderEnv': '环境变量',
  'settings.mediaProviderIntegrated': '已接入',
  'settings.mediaProviderPending': '占位（待接入）',
  'settings.mediaProviderDocs': '获取 Key →',
  ...
  'settings.mediaSectionExpand': '展开更多',
  'settings.mediaSectionCollapse': '收起',
  ...
  'promptTemplates.countLabel': '{n} 条结果',
  'promptTemplates.emptyImage': '尚未导入图片 prompt 模板。运行 `node scripts/import-prompt-templates.mjs` 拉取精选集。',
  'promptTemplates.emptyVideo': '尚未导入视频 prompt 模板。运行 `node scripts/import-prompt-templates.mjs` 拉取精选集。',
  'promptTemplates.emptyNoMatch': '没有匹配的模板。',
  'promptTemplates.attributionFooter': '改编自 YouMind OpenLab 的公开 CC BY 4.0 prompt 库，每张卡片都链接到原作者。详见 CREDITS.md。',
  'promptTemplates.openPreviewTitle': '查看 prompt + 预览',
  'promptTemplates.sourcePrefix': '来源：',
  'promptTemplates.fetchError': '无法加载该模板的内容。',
  'promptTemplates.promptLabel': 'Prompt 内容',
  'promptTemplates.copyPrompt': '复制 prompt',
  'promptTemplates.copyDone': '已复制！',
  'promptTemplates.modelHint': '推荐模型：{model}',
  'promptTemplates.openSource': '查看原文 →',
  'promptTemplates.openFullscreen': '全屏沉浸预览',
  'promptTemplates.closeFullscreen': '退出全屏',
  ...
  'newproj.modelConfigureCta': '配置 Key',
  'newproj.modelConfigureTitle': '前往设置为 {provider} 添加 API Key',
  'newproj.modelNeedsKeyTitle': '{provider} 需要 API Key',
  'newproj.modelNeedsKeyBody': '在配置 Key 之前，生成将回退为占位资源。',
  ...
  'newproj.voiceLabel': '声线 / Voice ID（仅 TTS）',
  'newproj.voicePlaceholder': '例如：MiniMax 的 male-qn-qingse；留空则使用默认声线',
  ...
  'newproj.promptTemplateLabel': 'Prompt 模板（可选）',
  'newproj.promptTemplateNone': '不使用模板 — 从零开始写',
  'newproj.promptTemplateNoneSub': '仅使用你的需求',
  'newproj.promptTemplateSearch': '搜索模板…',
  'newproj.promptTemplateEmpty': '没有匹配项。',
