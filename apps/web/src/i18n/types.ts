...
export interface Dict {
  ...
  // Edit inspector (legacy — from our removed in-preview Edit mode; kept
  // as valid keys so we don't have to churn 16 locale files. Unused after
  // adopting upstream's official manual edit-mode. TODO: prune later.)
