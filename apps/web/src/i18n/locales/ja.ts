...
export const ja: Dict = {
  ...
  'editInspector.title': '要素を編集',
  'editInspector.empty': 'プレビュー上の要素をクリックして編集します',
  'editInspector.close': '編集モードを閉じる',
  'editInspector.tag': 'タグ',
  'editInspector.classes': 'クラス',
  'editInspector.selectorAnchor': 'アンカー',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': '構造パス',
  'editInspector.text': 'テキスト',
  'editInspector.textApply': 'テキストを適用',
  'editInspector.textDisabledHasChildren':
    'この要素には子要素があります。テキストを編集すると子要素が置き換えられます。',
  'editInspector.color': '色',
  'editInspector.background': '背景',
  'editInspector.fontSize': 'フォントサイズ',
  'editInspector.fontWeight': 'フォントの太さ',
  'editInspector.textAlign': '文字揃え',
  'editInspector.padding': '内側余白',
  'editInspector.margin': '外側余白',
  'editInspector.borderRadius': '角丸',
  'editInspector.advanced': '詳細',
  'editInspector.reset': 'リセット',
  ...
  'fileViewer.edit': '編集',
  'fileViewer.editEnabled': '編集モード オン — 要素をクリックしてください',
  'fileViewer.editDisabled': '編集モード オフ',
  'fileViewer.editSave': '保存',
  'fileViewer.editSaving': '保存中…',
  'fileViewer.editSaved': '保存しました',
  'fileViewer.editSaveFailed': '保存に失敗しました — コンソールを確認してください',
  'fileViewer.editExit': '編集モードを終了',
  'fileViewer.draw': '描画',
