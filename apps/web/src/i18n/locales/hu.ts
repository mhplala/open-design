...
export const hu: Dict = {
  ...
  'editInspector.title': 'Elem szerkesztése',
  'editInspector.empty': 'Kattints egy elemre az előnézetben a szerkesztéshez',
  'editInspector.close': 'Szerkesztő mód bezárása',
  'editInspector.tag': 'Tag',
  'editInspector.classes': 'Osztályok',
  'editInspector.selectorAnchor': 'Horgony',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'szerkezeti útvonal',
  'editInspector.text': 'Szöveg',
  'editInspector.textApply': 'Szöveg alkalmazása',
  'editInspector.textDisabledHasChildren':
    'Ennek az elemnek vannak gyermek elemei; a szöveg szerkesztése felülírná őket.',
  'editInspector.color': 'Szín',
  'editInspector.background': 'Háttér',
  'editInspector.fontSize': 'Betűméret',
  'editInspector.fontWeight': 'Betűvastagság',
  'editInspector.textAlign': 'Igazítás',
  'editInspector.padding': 'Belső térköz',
  'editInspector.margin': 'Külső térköz',
  'editInspector.borderRadius': 'Sarokkerekítés',
  'editInspector.advanced': 'Speciális',
  'editInspector.reset': 'Visszaállítás',
  ...
  'fileViewer.editEnabled': 'Szerkesztő mód bekapcsolva — kattints egy elemre',
  'fileViewer.editDisabled': 'Szerkesztő mód kikapcsolva',
  'fileViewer.editSave': 'Mentés',
  'fileViewer.editSaving': 'Mentés…',
  'fileViewer.editSaved': 'Elmentve',
  'fileViewer.editSaveFailed': 'Mentés sikertelen — nézd meg a konzolt',
  'fileViewer.editExit': 'Kilépés a szerkesztő módból',
