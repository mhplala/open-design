...
export const ru: Dict = {
  ...
  'editInspector.title': 'Редактировать элемент',
  'editInspector.empty': 'Нажмите на элемент в предпросмотре, чтобы отредактировать его',
  'editInspector.close': 'Закрыть режим редактирования',
  'editInspector.tag': 'Тег',
  'editInspector.classes': 'Классы',
  'editInspector.selectorAnchor': 'Якорь',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'структурный путь',
  'editInspector.text': 'Текст',
  'editInspector.textApply': 'Применить текст',
  'editInspector.textDisabledHasChildren':
    'Этот элемент содержит дочерние элементы; редактирование текста заменит их.',
  'editInspector.color': 'Цвет',
  'editInspector.background': 'Фон',
  'editInspector.fontSize': 'Размер шрифта',
  'editInspector.fontWeight': 'Насыщенность шрифта',
  'editInspector.textAlign': 'Выравнивание текста',
  'editInspector.padding': 'Внутренний отступ',
  'editInspector.margin': 'Внешний отступ',
  'editInspector.borderRadius': 'Скругление углов',
  'editInspector.advanced': 'Дополнительно',
  'editInspector.reset': 'Сбросить',
  ...
  'fileViewer.editEnabled': 'Режим редактирования включён — выберите элемент',
  'fileViewer.editDisabled': 'Режим редактирования выключен',
  'fileViewer.editSave': 'Сохранить',
  'fileViewer.editSaving': 'Сохранение…',
  'fileViewer.editSaved': 'Сохранено',
  'fileViewer.editSaveFailed': 'Не удалось сохранить — см. консоль',
  'fileViewer.editExit': 'Выйти из режима редактирования',
