...
export const uk: Dict = {
  ...
  'editInspector.title': 'Редагувати елемент',
  'editInspector.empty': 'Натисніть на елемент у попередньому перегляді, щоб відредагувати його',
  'editInspector.close': 'Вийти з режиму редагування',
  'editInspector.tag': 'Тег',
  'editInspector.classes': 'Класи',
  'editInspector.selectorAnchor': 'Якір',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'структурний шлях',
  'editInspector.text': 'Текст',
  'editInspector.textApply': 'Застосувати текст',
  'editInspector.textDisabledHasChildren':
    'Цей елемент містить дочірні елементи; редагування його тексту замінить їх.',
  'editInspector.color': 'Колір',
  'editInspector.background': 'Фон',
  'editInspector.fontSize': 'Розмір шрифту',
  'editInspector.fontWeight': 'Насиченість шрифту',
  'editInspector.textAlign': 'Вирівнювання тексту',
  'editInspector.padding': 'Внутрішні відступи',
  'editInspector.margin': 'Зовнішні відступи',
  'editInspector.borderRadius': 'Радіус заокруглення',
  'editInspector.advanced': 'Додатково',
  'editInspector.reset': 'Скинути',
  ...
  'fileViewer.editEnabled': 'Режим редагування увімкнено — натисніть на елемент',
  'fileViewer.editDisabled': 'Режим редагування вимкнено',
  'fileViewer.editSave': 'Зберегти',
  'fileViewer.editSaving': 'Збереження…',
  'fileViewer.editSaved': 'Збережено',
  'fileViewer.editSaveFailed': 'Не вдалося зберегти — див. консоль',
  'fileViewer.editExit': 'Вийти з режиму редагування',
