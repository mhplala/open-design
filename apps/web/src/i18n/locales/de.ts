...
export const de: Dict = {
  ...
  'editInspector.title': 'Element bearbeiten',
  'editInspector.empty': 'Wähle ein Element in der Vorschau aus, um es zu bearbeiten',
  'editInspector.close': 'Bearbeitungsmodus schließen',
  'editInspector.tag': 'Tag',
  'editInspector.classes': 'Klassen',
  'editInspector.selectorAnchor': 'Anker',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'Strukturpfad',
  'editInspector.text': 'Text',
  'editInspector.textApply': 'Text übernehmen',
  'editInspector.textDisabledHasChildren':
    'Dieses Element enthält Kindelemente; das Bearbeiten des Texts würde sie ersetzen.',
  'editInspector.color': 'Farbe',
  'editInspector.background': 'Hintergrund',
  'editInspector.fontSize': 'Schriftgröße',
  'editInspector.fontWeight': 'Schriftstärke',
  'editInspector.textAlign': 'Textausrichtung',
  'editInspector.padding': 'Innenabstand',
  'editInspector.margin': 'Außenabstand',
  'editInspector.borderRadius': 'Eckenradius',
  'editInspector.advanced': 'Erweitert',
  'editInspector.reset': 'Zurücksetzen',
  ...
  'fileViewer.editEnabled': 'Bearbeitungsmodus aktiv — Element auswählen',
  'fileViewer.editDisabled': 'Bearbeitungsmodus aus',
  'fileViewer.editSave': 'Speichern',
  'fileViewer.editSaving': 'Speichern…',
  'fileViewer.editSaved': 'Gespeichert',
  'fileViewer.editSaveFailed': 'Speichern fehlgeschlagen — siehe Konsole',
  'fileViewer.editExit': 'Bearbeitungsmodus verlassen',
