...
export const ko: Dict = {
  ...
  'editInspector.title': '요소 편집',
  'editInspector.empty': '미리보기에서 편집할 요소를 클릭하세요',
  'editInspector.close': '편집 모드 닫기',
  'editInspector.tag': '태그',
  'editInspector.classes': '클래스',
  'editInspector.selectorAnchor': '앵커',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': '구조 경로',
  'editInspector.text': '텍스트',
  'editInspector.textApply': '텍스트 적용',
  'editInspector.textDisabledHasChildren':
    '이 요소에는 하위 요소가 있습니다. 텍스트를 수정하면 하위 요소가 모두 대체됩니다.',
  'editInspector.color': '색상',
  'editInspector.background': '배경',
  'editInspector.fontSize': '글자 크기',
  'editInspector.fontWeight': '글자 굵기',
  'editInspector.textAlign': '텍스트 정렬',
  'editInspector.padding': '안쪽 여백',
  'editInspector.margin': '바깥 여백',
  'editInspector.borderRadius': '모서리 반경',
  'editInspector.advanced': '고급',
  'editInspector.reset': '초기화',
  ...
  'fileViewer.edit': '편집',
  'fileViewer.editEnabled': '편집 모드 켜짐 — 요소를 클릭하세요',
  'fileViewer.editDisabled': '편집 모드 꺼짐',
  'fileViewer.editSave': '저장',
  'fileViewer.editSaving': '저장 중…',
  'fileViewer.editSaved': '저장됨',
  'fileViewer.editSaveFailed': '저장 실패 — 콘솔을 확인하세요',
  'fileViewer.editExit': '편집 모드 종료',
  'fileViewer.draw': '그리기',
