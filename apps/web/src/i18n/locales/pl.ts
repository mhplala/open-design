...
export const pl: Dict = {
  ...
  'editInspector.title': 'Edytuj element',
  'editInspector.empty': 'Kliknij element w podglądzie, aby go edytować',
  'editInspector.close': 'Zamknij tryb edycji',
  'editInspector.tag': 'Tag',
  'editInspector.classes': 'Klasy',
  'editInspector.selectorAnchor': 'Kotwica',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'ścieżka strukturalna',
  'editInspector.text': 'Tekst',
  'editInspector.textApply': 'Zastosuj tekst',
  'editInspector.textDisabledHasChildren':
    'Ten element zawiera elementy podrzędne; edycja jego tekstu zastąpiłaby je.',
  'editInspector.color': 'Kolor',
  'editInspector.background': 'Tło',
  'editInspector.fontSize': 'Rozmiar czcionki',
  'editInspector.fontWeight': 'Grubość czcionki',
  'editInspector.textAlign': 'Wyrównanie tekstu',
  'editInspector.padding': 'Wypełnienie',
  'editInspector.margin': 'Margines',
  'editInspector.borderRadius': 'Zaokrąglenie',
  'editInspector.advanced': 'Zaawansowane',
  'editInspector.reset': 'Resetuj',
  ...
  'fileViewer.editEnabled': 'Tryb edycji włączony — kliknij element',
  'fileViewer.editDisabled': 'Tryb edycji wyłączony',
  'fileViewer.editSave': 'Zapisz',
  'fileViewer.editSaving': 'Zapisywanie…',
  'fileViewer.editSaved': 'Zapisano',
  'fileViewer.editSaveFailed': 'Zapis nieudany — sprawdź konsolę',
  'fileViewer.editExit': 'Wyjdź z trybu edycji',
