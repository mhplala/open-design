...
export const fa: Dict = {
  ...
  'editInspector.title': 'ویرایش عنصر',
  'editInspector.empty': 'برای ویرایش، روی عنصری در پیش‌نمایش کلیک کنید',
  'editInspector.close': 'بستن حالت ویرایش',
  'editInspector.tag': 'تگ',
  'editInspector.classes': 'کلاس‌ها',
  'editInspector.selectorAnchor': 'لنگر',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'مسیر ساختاری',
  'editInspector.text': 'متن',
  'editInspector.textApply': 'اعمال متن',
  'editInspector.textDisabledHasChildren':
    'این عنصر دارای فرزند است؛ ویرایش متن آن، فرزندان را جایگزین می‌کند.',
  'editInspector.color': 'رنگ',
  'editInspector.background': 'پس‌زمینه',
  'editInspector.fontSize': 'اندازه قلم',
  'editInspector.fontWeight': 'ضخامت قلم',
  'editInspector.textAlign': 'تراز متن',
  'editInspector.padding': 'فاصله داخلی',
  'editInspector.margin': 'فاصله بیرونی',
  'editInspector.borderRadius': 'گردی گوشه',
  'editInspector.advanced': 'پیشرفته',
  'editInspector.reset': 'بازنشانی',
  ...
  'fileViewer.editEnabled': 'حالت ویرایش فعال است — روی عنصری کلیک کنید',
  'fileViewer.editDisabled': 'حالت ویرایش غیرفعال است',
  'fileViewer.editSave': 'ذخیره',
  'fileViewer.editSaving': 'در حال ذخیره…',
  'fileViewer.editSaved': 'ذخیره شد',
  'fileViewer.editSaveFailed': 'ذخیره ناموفق بود — کنسول را بررسی کنید',
  'fileViewer.editExit': 'خروج از حالت ویرایش',
  'fileViewer.draw': 'رسم',
