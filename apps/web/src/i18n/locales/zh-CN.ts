...
export const zhCN: Dict = {
  ...
  'editInspector.title': '编辑元素',
  'editInspector.empty': '在预览中点选一个元素开始编辑',
  'editInspector.close': '退出编辑模式',
  'editInspector.tag': '标签',
  'editInspector.classes': '类名',
  'editInspector.selectorAnchor': '锚点',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': '结构路径',
  'editInspector.text': '文本',
  'editInspector.textApply': '应用文本',
  'editInspector.textDisabledHasChildren': '该元素包含子元素，修改文本会把它们一并替换掉。',
  'editInspector.color': '颜色',
  'editInspector.background': '背景',
  'editInspector.fontSize': '字号',
  'editInspector.fontWeight': '字重',
  'editInspector.textAlign': '对齐',
  'editInspector.padding': '内边距',
  'editInspector.margin': '外边距',
  'editInspector.borderRadius': '圆角',
  'editInspector.advanced': '高级',
  'editInspector.reset': '重置',
  ...
  'fileViewer.edit': '编辑',
  'fileViewer.editEnabled': '编辑模式已开启 — 点选一个元素',
  'fileViewer.editDisabled': '编辑模式已关闭',
  'fileViewer.editSave': '保存',
  'fileViewer.editSaving': '保存中…',
  'fileViewer.editSaved': '已保存',
  'fileViewer.editSaveFailed': '保存失败 — 请查看控制台',
  'fileViewer.editExit': '退出编辑模式',
  'fileViewer.draw': '绘制',
