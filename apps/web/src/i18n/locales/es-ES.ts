...
export const esES: Dict = {
  ...
  'editInspector.title': 'Editar elemento',
  'editInspector.empty': 'Haz clic en un elemento de la vista previa para editarlo',
  'editInspector.close': 'Cerrar modo edición',
  'editInspector.tag': 'Etiqueta',
  'editInspector.classes': 'Clases',
  'editInspector.selectorAnchor': 'Ancla',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'ruta estructural',
  'editInspector.text': 'Texto',
  'editInspector.textApply': 'Aplicar texto',
  'editInspector.textDisabledHasChildren':
    'Este elemento tiene elementos hijos; editar su texto los reemplazaría.',
  'editInspector.color': 'Color',
  'editInspector.background': 'Fondo',
  'editInspector.fontSize': 'Tamaño de fuente',
  'editInspector.fontWeight': 'Grosor de fuente',
  'editInspector.textAlign': 'Alineación',
  'editInspector.padding': 'Relleno',
  'editInspector.margin': 'Margen',
  'editInspector.borderRadius': 'Radio de borde',
  'editInspector.advanced': 'Avanzado',
  'editInspector.reset': 'Restablecer',
  ...
  'fileViewer.editEnabled': 'Modo edición activo — haz clic en un elemento',
  'fileViewer.editDisabled': 'Modo edición desactivado',
  'fileViewer.editSave': 'Guardar',
  'fileViewer.editSaving': 'Guardando…',
  'fileViewer.editSaved': 'Guardado',
  'fileViewer.editSaveFailed': 'Error al guardar — revisa la consola',
  'fileViewer.editExit': 'Salir del modo edición',
