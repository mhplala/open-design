...
export const ar: Dict = {
  ...
  'editInspector.title': 'تعديل العنصر',
  'editInspector.empty': 'انقر على عنصر في المعاينة لتعديله',
  'editInspector.close': 'إغلاق وضع التعديل',
  'editInspector.tag': 'الوسم',
  'editInspector.classes': 'الفئات',
  'editInspector.selectorAnchor': 'المرساة',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'المسار البنيوي',
  'editInspector.text': 'النص',
  'editInspector.textApply': 'تطبيق النص',
  'editInspector.textDisabledHasChildren':
    'يحتوي هذا العنصر على عناصر فرعية؛ تعديل نصّه سيستبدلها.',
  'editInspector.color': 'اللون',
  'editInspector.background': 'الخلفية',
  'editInspector.fontSize': 'حجم الخط',
  'editInspector.fontWeight': 'سُمك الخط',
  'editInspector.textAlign': 'محاذاة النص',
  'editInspector.padding': 'الحشو الداخلي',
  'editInspector.margin': 'الهامش الخارجي',
  'editInspector.borderRadius': 'استدارة الحواف',
  'editInspector.advanced': 'متقدّم',
  'editInspector.reset': 'إعادة الضبط',
  ...
  'fileViewer.editEnabled': 'وضع التعديل مفعّل — انقر على عنصر',
  'fileViewer.editDisabled': 'وضع التعديل متوقف',
  'fileViewer.editSave': 'حفظ',
  'fileViewer.editSaving': 'جارٍ الحفظ…',
  'fileViewer.editSaved': 'تم الحفظ',
  'fileViewer.editSaveFailed': 'فشل الحفظ — راجع وحدة التحكم',
  'fileViewer.editExit': 'الخروج من وضع التعديل',
  'fileViewer.draw': 'رسم',
