...
export const zhTW: Dict = {
  ...
  'editInspector.title': '編輯元素',
  'editInspector.empty': '在預覽中點選一個元素以開始編輯',
  'editInspector.close': '離開編輯模式',
  'editInspector.tag': '標籤',
  'editInspector.classes': '類別',
  'editInspector.selectorAnchor': '錨點',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': '結構路徑',
  'editInspector.text': '文字',
  'editInspector.textApply': '套用文字',
  'editInspector.textDisabledHasChildren': '此元素包含子元素，修改文字會將它們一併取代。',
  'editInspector.color': '顏色',
  'editInspector.background': '背景',
  'editInspector.fontSize': '字級',
  'editInspector.fontWeight': '字重',
  'editInspector.textAlign': '對齊',
  'editInspector.padding': '內距',
  'editInspector.margin': '外距',
  'editInspector.borderRadius': '圓角',
  'editInspector.advanced': '進階',
  'editInspector.reset': '重設',
  ...
  'fileViewer.edit': '編輯',
  'fileViewer.editEnabled': '編輯模式已開啟 — 點選一個元素',
  'fileViewer.editDisabled': '編輯模式已關閉',
  'fileViewer.editSave': '儲存',
  'fileViewer.editSaving': '儲存中…',
  'fileViewer.editSaved': '已儲存',
  'fileViewer.editSaveFailed': '儲存失敗 — 請查看主控台',
  'fileViewer.editExit': '離開編輯模式',
  'fileViewer.draw': '繪製',
