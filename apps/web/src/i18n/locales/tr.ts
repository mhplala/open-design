...
export const tr: Dict = {
  ...
  'editInspector.title': 'Öğeyi düzenle',
  'editInspector.empty': 'Düzenlemek için ön izlemedeki bir öğeye tıklayın',
  'editInspector.close': 'Düzenleme modunu kapat',
  'editInspector.tag': 'Etiket',
  'editInspector.classes': 'Sınıflar',
  'editInspector.selectorAnchor': 'Çapa',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'yapısal yol',
  'editInspector.text': 'Metin',
  'editInspector.textApply': 'Metni uygula',
  'editInspector.textDisabledHasChildren':
    'Bu öğenin alt öğeleri var; metni düzenlemek onların yerini alır.',
  'editInspector.color': 'Renk',
  'editInspector.background': 'Arka plan',
  'editInspector.fontSize': 'Yazı boyutu',
  'editInspector.fontWeight': 'Yazı kalınlığı',
  'editInspector.textAlign': 'Metin hizalama',
  'editInspector.padding': 'İç boşluk',
  'editInspector.margin': 'Dış boşluk',
  'editInspector.borderRadius': 'Kenar yuvarlaklığı',
  'editInspector.advanced': 'Gelişmiş',
  'editInspector.reset': 'Sıfırla',
  ...
  'fileViewer.editEnabled': 'Düzenleme modu açık — bir öğeye tıklayın',
  'fileViewer.editDisabled': 'Düzenleme modu kapalı',
  'fileViewer.editSave': 'Kaydet',
  'fileViewer.editSaving': 'Kaydediliyor…',
  'fileViewer.editSaved': 'Kaydedildi',
  'fileViewer.editSaveFailed': 'Kaydedilemedi — konsola bakın',
  'fileViewer.editExit': 'Düzenleme modundan çık',
  'fileViewer.draw': 'Çiz',
