...
export const ptBR: Dict = {
  ...
  'editInspector.empty': 'Clique em um elemento na prévia para editá-lo',
  'editInspector.close': 'Sair do modo de edição',
  'editInspector.tag': 'Tag',
  'editInspector.classes': 'Classes',
  'editInspector.selectorAnchor': 'Âncora',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'caminho estrutural',
  'editInspector.text': 'Texto',
  'editInspector.textApply': 'Aplicar texto',
  'editInspector.textDisabledHasChildren':
    'Este elemento tem filhos; editar o texto substituiria todos eles.',
  'editInspector.color': 'Cor',
  'editInspector.background': 'Fundo',
  'editInspector.fontSize': 'Tamanho da fonte',
  'editInspector.fontWeight': 'Peso da fonte',
  'editInspector.textAlign': 'Alinhamento',
  'editInspector.padding': 'Espaçamento interno',
  'editInspector.margin': 'Margem',
  'editInspector.borderRadius': 'Raio da borda',
  'editInspector.advanced': 'Avançado',
  'editInspector.reset': 'Redefinir',
  ...
  'fileViewer.editEnabled': 'Modo de edição ativado — clique em um elemento',
  'fileViewer.editDisabled': 'Modo de edição desativado',
  'fileViewer.editSave': 'Salvar',
  'fileViewer.editSaving': 'Salvando…',
  'fileViewer.editSaved': 'Salvo',
  'fileViewer.editSaveFailed': 'Falha ao salvar — veja o console',
  'fileViewer.editExit': 'Sair do modo de edição',
