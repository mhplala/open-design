...
export const en: Dict = {
  ...
  'editInspector.title': 'Edit element',
  'editInspector.empty': 'Click an element in the preview to edit it',
  'editInspector.close': 'Close edit mode',
  'editInspector.tag': 'Tag',
  'editInspector.classes': 'Classes',
  'editInspector.selectorAnchor': 'Anchor',
  'editInspector.selectorAnchorOdId': 'data-od-id',
  'editInspector.selectorAnchorPath': 'structural path',
  'editInspector.text': 'Text',
  'editInspector.textApply': 'Apply text',
  'editInspector.textDisabledHasChildren':
    'This element has child elements; editing its text would replace them.',
  'editInspector.color': 'Color',
  'editInspector.background': 'Background',
  'editInspector.fontSize': 'Font size',
  'editInspector.fontWeight': 'Font weight',
  'editInspector.textAlign': 'Text align',
  'editInspector.padding': 'Padding',
  'editInspector.margin': 'Margin',
  'editInspector.borderRadius': 'Border radius',
  'editInspector.advanced': 'Advanced',
  'editInspector.reset': 'Reset',
  ...
  'fileViewer.editEnabled': 'Edit mode on — click an element',
  'fileViewer.editDisabled': 'Edit mode off',
  'fileViewer.editSave': 'Save',
  'fileViewer.editSaving': 'Saving…',
  'fileViewer.editSaved': 'Saved',
  'fileViewer.editSaveFailed': 'Save failed — see console',
  'fileViewer.editExit': 'Exit edit mode',
